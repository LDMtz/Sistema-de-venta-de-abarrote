...
<?php include("ActualizaCliente.php"); ?>
        ...
        <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $datosCliente['Telefono']?>"
